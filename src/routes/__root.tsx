  ...
  head: () => ({
    meta: [
      ...
      { title: "Adeconex — Plataforma de impressão térmica e identificação" },
      {
        name: "description",
        content:
          "Adeconex: autoridade nacional em impressão térmica, etiquetas, ribbons, RFID, automação comercial e logística. Conteúdo técnico, ferramentas gratuitas e produtos.",
      },
